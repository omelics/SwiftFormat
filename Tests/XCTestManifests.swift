...
extension RulesTests {
    static let __allTests = [
        ...
        ("testNonRedundantEnumIntsNotRemoved", testNonRedundantEnumIntsNotRemoved),
        ...
        ("testRedundantEnumFloatsRemoved", testRedundantEnumFloatsRemoved),
        ("testRedundantEnumIntsRemoved", testRedundantEnumIntsRemoved),
